...
<div class="modal modal-bottom sm:modal-middle">
  ...
  <div class="modal-box">
          ...
          <div class="form-control">
            ...
            <input type="text" value={user?.displayName}  placeholder="Name" class="input input-bordered" />
          </div>
          <div class="form-control">
            <label class="label">
          ...
          <div class="form-control">
            ...
            <input type="text" d value={user?.email} placeholder="email" class="input input-bordered" />
          </div>
          <div class="form-control">
            <label class="label">
