  ...
  <div class="modal-box">
        <h1 className="text-red-500 text-center">BUY BOOK </h1>
          ...
          <div class="form-control">
            ...
            <input type="text" value={formattedDate} d placeholder="address" class="input input-bordered" />
          ...
          <div class="form-control">
            ...
            <input type="text" value={formattedDate} placeholder="address" class="input input-bordered" />
