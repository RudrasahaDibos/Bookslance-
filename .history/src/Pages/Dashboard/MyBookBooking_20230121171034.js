    ...
    <tbody>
        {
           bookbookings.map((bookbooking ,index) => <tr>
            ...
            <td>
          {(bookbooking.price && !bookbooking.paid)  && <Link to={`/dashboard/payment/${a._id}`} ><button className="btn btn-success">pay</button> </Link> }
          {(bookbooking.price && a.paid)  && <span className="text-success"> paid </span> }
