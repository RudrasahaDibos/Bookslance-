    ...
    <tbody>
        {
           bookbookings.map((bookbooking ,index) => <tr>
            ...
            <td>
          {(bookbooking.GrandTotal && !bookbooking.paid)  && <Link to={`/dashboard/payment/${bookbooking._id}`} ><button className="btn btn-success">pay</button> </Link> }
          {(bookbooking.GrandTotal && bookbooking.paid)  && <span className="text-success"> paid </span> }
