...
const Payment = () => {
  ...
  <div class="card-body">
    <p className='text-success' >Hello, {bookbooking.patientName}</p>
    <h1 className='card-title'>Please pay for  {bookbooking.treatment}</h1>
    <p>Your Appointment : <span className='text-red-500'>{bookbooking.date}</span> </p>
    <p>Please pay :  $  <span>{bookbooking.treatment}</span> </p>
  </div>
</div>
