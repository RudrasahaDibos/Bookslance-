...
const Product = ({ product, handleAddtoCart }) => {
  ...
  return (
        ...
        <label for="my-modal-6"   class="group-hover/edit:btn  "><span>View Details</span></label>
        <div  class="card   w-60 bg-base-50 shadow-xl">
        
        <li class="group/item hover:bg-slate-100 ...">
        <a class="group/edit invisible hover:bg-slate-200 group-hover/item:visible">
        <label for="my-modal-6"   class="group-hover/edit:text-gray-700  "><span>View Details</span></label>
      </a>
