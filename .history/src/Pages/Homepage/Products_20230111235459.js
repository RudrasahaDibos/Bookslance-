...
const Products = () => {
  ...
  useEffect(()=>{
    fetch('http://localhost:5000/bookproductCount')
    .then(res=>res.json()
    .then(data=>
      {
        const count = data.count;
        const pages = Math.cli
      }
  ...
  <div className=' justify-center  ml-10  mr-32 mt-10  grid lg:grid-cols-3 lg:gap-10 md:grid-cols-2 md:gap-8 sm:grid-cols-1 gap-1'>
