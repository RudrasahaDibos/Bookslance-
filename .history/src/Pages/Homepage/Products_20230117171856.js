...
const Products = () => {
  ...
  return (
    <div className="flex display">
      <div className=" ">
        <div onClick={() => handleAddtoCart(product)}   className="justify-center  ml-10  mr-32 mt-10  grid lg:grid-cols-4 lg:gap-10 md:grid-cols-2 md:gap-8 sm:grid-cols-1 gap-1">
