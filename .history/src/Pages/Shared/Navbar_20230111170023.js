  ...
  const Menubar = <>
    ...
    return (
        ...
        <div class="navbar-start">
          <div class="dropdown">
            ...
            <div class="flex-none gap-2 lg:hidden menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 ">
    <div class="form-control">
      <input type="text" placeholder="Search" class="input input-bordered" />
        ...
        <div class="flex-none gap-2 hidden  menu-horizontal  lg:flex ">
    <div class="form-control">
      <input type="text" placeholder="Search" class="input input-bordered" />
    </div>
    </div>
