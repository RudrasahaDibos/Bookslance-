  ...
  const Menubar = (
    <>
      <div class="flex-none gap-2  sm:w-10 sm:mr-24  lg:w-20  lg:mr-60  ">
        <div class="form-control flex-row relative sm:w-10 sm:mr-24  lg:w-20  lg:mr-60">
          <input
            id="search-field"
            type="text"
            placeholder="Search"
          ...
          <div className="absolute bg-white top-full left-0 sm:w-10 sm:mr-24  lg:w-20  lg:mr-60 z-50">{keyword}</div>
        </div>
      </div>
      <li>
