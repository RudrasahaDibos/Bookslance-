...
const Navber = () => {
  ...
  const Menubar = (
    <>
      <div class="flex-none gap-2  sm:w-10 w-full relative ">
        <div class="form-control flex-row sm:w-10 w-full">
          <input
            id="search-field"
            type="text"
            placeholder="Search"
          ...
          <div className="absolute bg-white top-full left-0 w-full z-50">{keyword}</div>
        </div>
      </div>
      <li>
